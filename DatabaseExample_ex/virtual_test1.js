...
function connectDB() {
    ...
    database.on('error', console.error.bind(console.error, 'mongoose connection error.'));
    ...
    database.on('disconnectied', connectDB);
}
...
function createUserSchema() {
    // 스키마 정의
    // password를 hashed_pawwword로 변경, default 속성 무도가, salt 속성 추가
    ...
    // UserModel 모델 정의
    UserModel = mongoose.model("uses4", UserSchema);
